...
figlet selamat mencoba | lolcat

echo "_____________________________________________________________"
echo "Tools      : Tools Hacking $white                         " |lolcat
echo "Creadby : MRX $white                                      " |lolcat
echo "FB           : Ripan Taopani   $white                             " |lolcat
echo "_____________________________________________________________"
